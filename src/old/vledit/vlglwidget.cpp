...
void vlGLWidget::initializeGL()
{
    ...
    mouseX=mouseY=0;
    switch (type) {
        case CORONAL: name=QString("Coronal");break;
        case SAGITTAL: name=QString("Sagittal");break;
        case AXIAL: name=QString("Axial");break;
        default: name=QString("Unbekannt");
    }
...
{
    switch (type) {
        case CORONAL:	UICONFIG->setAim(py, -1, px); break;
        case SAGITTAL:	UICONFIG->setAim(py, px, -1); break;
        case AXIAL:		UICONFIG->setAim(-1, py, px); break;
    }
}
