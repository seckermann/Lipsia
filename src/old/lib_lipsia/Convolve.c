/*
 *  $Id: Convolve.c 3181 2008-04-01 15:19:44Z karstenm $
 *
 *  This file contains routines for convolving images.
 */
						...
						VConvolvePadMethod pad_method, int shift )
{
	...
	/* Convert the mask image to pixels of type VLong or VDouble, if
	   necessary: */
	if ( VIsFloatPtRepn ( VPixelRepn ( src ) ) ||
		 VIsFloatPtRepn ( VPixelRepn ( mask ) ) )
		mask_repn = VDoubleRepn;
	else mask_repn = VLongRepn;
