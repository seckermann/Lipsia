...
void Configurator::setInterpolationtype( interpol_type t )
{
	...
	switch ( t ) {
	case ip_nn:
		m_currInterpolator = new CNnMag();
		return;
	case ip_bilin:
		m_currInterpolator = new CBilinMag();
		return;
	case ip_bicub:
		m_currInterpolator = new CBicubSplineMag();
		return;
	case ip_bicub_6:
		m_currInterpolator = new CBicub6Mag();
		return;
	case ip_bspline:
		m_currInterpolator = new CBSplineMag();
		return;
	}
}
